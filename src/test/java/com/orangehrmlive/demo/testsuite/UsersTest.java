...
public class UsersTest extends BaseTest {
    ...
    public void adminShouldAddUserSuccessFully() {
        homePage.setEnterUserName("xyz");
        homePage.setEnterPassword("123");
        ...
        Assert.assertEquals(actualText, expectedText, "System User is not available");
        ...
        Assert.assertEquals(actualMessage, expectedText, "Add user is not displayed");
